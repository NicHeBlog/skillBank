...
- version: 2.0.0
- description: 分析客户系统建设需求，评估复杂度，推荐最合适的飞书工具（aPaaS、aily专业版、aily自定义智能体、aily工作流、妙搭）或工具组合，输出详细的建设方案。当用户描述系统建设需求、询问"该用什么工具"、"如何建设"、"需求分析"、"方案比选"、"工具推荐"、"系统选型"、"aPaaS还是智能体"、"建系统"、"搭建系统"、"用什么方案"、"哪个工具合适"时使用此技能。不适用于：纯代码开发需求、非飞书生态工具选型、硬件选型。
...
- allowed-tools: bash、image_generate、file、aily-pdf